...
public class DisclaimerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String aboutData = "The content posted, shared or otherwise generated by users in the Muavin community space doesn’t necessarily reflect or in any way express the views of Media Matters for Democracy or Code for Pakistan.<br>" +
