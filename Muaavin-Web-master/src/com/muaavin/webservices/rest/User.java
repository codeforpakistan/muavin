...
public class User
{
  ...
  public String toString()
  {
    try
    {
      return new JSONObject().put("User_Name", User_Name).put("User_ID", User_ID).put("Profile_Pic", Profile_Pic).put("State", State).put("IsTwitterUser", IsTwitterUser).put("blockDate", blockDate).toString();
  ...
  public static User initializeUser(String Name, String user_id, String profile_pic, String State, boolean isTwitteruser, String date)
  {
    User user = new User();
    user.User_Name = Name;
    user.User_ID = user_id;
